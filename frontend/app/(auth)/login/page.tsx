  ...
  return (
    <div className="min-h-screen lg:h-screen w-full flex flex-col bg-[#F8FAFC] text-slate-900 font-sans selection:bg-indigo-100 selection:text-indigo-900 relative lg:overflow-hidden">
      ...
      <div className="flex-1 flex flex-col lg:flex-row min-h-0 relative z-10 overflow-y-auto lg:overflow-hidden">
        {/* LEFT COLUMN: Brand Storytelling & Enterprise Logistics Operating System   */}
        <div className="hidden lg:flex lg:w-1/2 xl:w-[55%] flex-col justify-center gap-6 xl:gap-8 p-8 xl:p-12 border-r border-slate-200/80 bg-gradient-to-br from-slate-50 via-white to-indigo-50/20">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 border border-indigo-100 text-indigo-700 text-xs font-semibold">
              ...
              Next-Gen Autonomous Freight Core
            </div>
        ...
        <div className="max-w-xl w-full">
          <div className="rounded-2xl border border-slate-200/90 bg-white/90 backdrop-blur-md p-6 shadow-[0_4px_20px_rgba(15,23,42,0.04)] space-y-5">
            {/* Telemetry Header */}
            ...
            {/* Abstract Freight Corridor Nodes */}
        ...
        <div className="flex-1 flex flex-col justify-center items-center p-6 sm:p-8 relative z-10 overflow-y-auto">
          ...
          {/* Authentication Card */}
          <div className="bg-white rounded-2xl border border-slate-200/80 p-7 sm:p-9 shadow-[0_4px_24px_rgba(15,23,42,0.05)] transition-all space-y-6">
            {/* Header */}
            ...
            {/* 5. Polished Demo Workspace Drawer Feature */}
              ...
              <div className="p-3.5 rounded-xl bg-slate-50/90 border border-slate-200/70 hover:border-slate-300 transition-all">
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-slate-500 mt-0.5 leading-snug">
                        Explore PantherTMS using our demo environment.
                      </p>
                    </div>
                  </div>
                ...
                {isDemoExpanded && (
                  <div className="mt-3 pt-3 border-t border-slate-200/60 space-y-2 text-xs font-mono animate-in fade-in-0 slide-in-from-top-1 duration-150">
                    {/* Workspace */}
                    <div className="flex items-center justify-between p-1.5 rounded-lg bg-white border border-slate-200/70">
