      ...
      {data && (
        <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
          <Card className="p-4 bg-white border border-[#E4E7EC]">
            <span className="text-[11px] font-semibold text-[#667085] uppercase tracking-wider">Total Outstanding</span>
            ...
            <span className="text-[10px] text-[#667085] block mt-0.5">{data.debtor_count} debtors</span>
          </Card>
          ...
          <Card className="p-4 bg-white border border-[#E4E7EC]">
            ...
            <span className="text-[10px] text-[#667085] block mt-0.5">Current period</span>
          </Card>
          ...
          <Card className="p-4 bg-white border border-[#E4E7EC]">
            ...
            <span className="text-[10px] text-[#667085] block mt-0.5">Follow-up due</span>
          </Card>
          ...
          <Card className="p-4 bg-white border border-[#E4E7EC]">
            ...
            <span className="text-[10px] text-[#667085] block mt-0.5">Urgent collection</span>
          </Card>
          ...
          <Card className="p-4 bg-white border border-[#E4E7EC]">
            ...
            <span className="text-[10px] text-[#667085] block mt-0.5">Critical overdue</span>
          </Card>
        </div>
      )}
